...
public class FavouritesAdapter extends RecyclerView.Adapter<FavouritesAdapter.AdapterViewHolder> {
    ...
    public interface ListItemClickListener {
        void onListItemClick(com.example.emovs.GeneralShow generalShow);
    }

    public FavouritesAdapter(ListItemClickListener listener , ArrayList<com.example.emovs.GeneralShow> mData , Context applicationContext){
        this.mData = mData;
    ...
    public void onBindViewHolder(@NonNull AdapterViewHolder holder, int position) {
        ...
        com.example.emovs.GeneralShow.assignCat(mData.get(position).getCat_id() , context , holder.tvType);
