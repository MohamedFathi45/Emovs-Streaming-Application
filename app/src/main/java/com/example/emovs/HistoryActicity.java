...
import com.example.emovs.Loader_Tasks.HistoryLoader;

import java.util.ArrayList;

public class HistoryActicity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> , com.example.emovs.FavouritesAdapter.ListItemClickListener{

    private static final String SERVER_LOAD_HISTORY_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/read_history.php";
    ...
    public void onLoadFinished(@NonNull Loader<Object> loader, Object data) {
        ...
        if(id == MainActivity.LOADER_FOR_LOAD_HISTORY) {
            if(data != null) {
                ...
                com.example.emovs.FavouritesAdapter historyAdapter = new com.example.emovs.FavouritesAdapter(this, (ArrayList<com.example.emovs.GeneralShow>) data , this);
    ...
    @Override
    public void onListItemClick(com.example.emovs.GeneralShow generalShow) {
        if(generalShow.getCat_id() == 2) {
            Intent intent = new Intent(HistoryActicity.this, MovieDetailsActivity.class);
            com.example.emovs.Inventory.getInstance().add(generalShow);
            intent.putExtra(MainActivity.MOVIE_OBJECT_ID , String.valueOf(generalShow.getId()));
            startActivity(intent);
        }
        else{
            Intent intent = new Intent(HistoryActicity.this , com.example.emovs.SeriesDetailsActivity.class);
            com.example.emovs.Inventory.getInstance().add(generalShow);
