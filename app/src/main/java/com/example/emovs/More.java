...
import com.example.emovs.Loader_Tasks.SocialMediaLinksLoader;
...
public class More extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> {
    public static final String SERVER_DOWNLOAD_SCOIA_MEDIA_LINKS_API = MainActivity.SERVER_ROOT_LINK_URL+"/info/social_media";
