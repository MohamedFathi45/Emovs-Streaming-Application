...
import com.example.emovs.Loader_Tasks.MyListLoader;

import java.util.ArrayList;

public class MyListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> , FavouritesAdapter.ListItemClickListener {

    private static final String SERVER_LOAD_MY_LIST_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/read_my_list.php";
