...
import com.example.emovs.Loader_Tasks.TvShowsByTypeLoader;

import java.util.ArrayList;

public class MoreShowsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object>{
    ...
    public static final String SERVER_LOAD_TV_SHOWS_BY_TYPE_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/read_tv_shows_by_type.php";
    ...
    public void onLoadFinished(@NonNull Loader<Object> loader, Object data) {
        ...
        if(id == MainActivity.LOADER_FOR_LOAD_TV_SHOWS_BY_TYPE) {
            if(data != null) {
                ...
                com.example.emovs.GeneralShowAdapterGridView movieAdapter = new com.example.emovs.GeneralShowAdapterGridView(this, (ArrayList<com.example.emovs.GeneralShow>) data);
