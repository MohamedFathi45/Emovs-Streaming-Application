...
import com.example.emovs.Loader_Tasks.EpisodesLoader;

import java.math.BigInteger;
import java.util.ArrayList;

public class EpisodesActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> , EpisodeAdapter.ListItemClickListener , EpisodeAdapter.CommentItemClickListener{
    ...
    String session_id;
    private static final String SERVER_LOAD_EPISODS_API = MainActivity.SERVER_ROOT_LINK_URL+"/shows/series";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show = com.example.emovs.Inventory.getInstance().getShow(new BigInteger(show_id));
    ...
    private void getEpisodesFromServer(String tv_showId , String session_id) {
        ...
        queryBundle.putString(MainActivity.SERVER_LINK , SERVER_LOAD_EPISODS_API+"/"+tv_showId+"/"+session_id);
    ...
    public void onListItemClick(Episode episode) {
        Intent intent = new Intent(this , com.example.emovs.ServerActivity.class);
    ...
    public void onCommentItemClick(Episode episode) {
        Intent intent = new Intent(this , com.example.emovs.CommentActivity.class);
        intent.putExtra(MainActivity.ID , String.valueOf(show.getId()));
        intent.putExtra(SeriesDetailsActivity.IDTWO , String.valueOf(session_id));
