...
import com.example.emovs.Loader_Tasks.EpisodeLinksLoader;

import java.util.ArrayList;
import java.util.Objects;

public class ServerActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object> , ServerShowAdapter.ListItemClickListener , AvilableQualityAdapter.ListItemClickListener{
    private static final String SERVER_LOAD_EPISODE_LINKS_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/read_episode_links.php";
