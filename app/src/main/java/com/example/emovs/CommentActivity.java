...
import com.example.emovs.Loader_Tasks.EpisodeCommentInsertionLoader;
import com.example.emovs.Loader_Tasks.EpisodeCommentLoader;
...
public class CommentActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Object>{
    ...
    ImageView sendImage;
    com.example.emovs.GeneralShow show;
    String session_id;
    String episode_id;
    int operationCount = 0;
    int numOfOperations = 1;
    public static final String SERVER_GET_EPISODE_COMMENTS_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/read_comments.php";
    public static final String SERVER_INSERT_EPISODE_COMMENT_API = MainActivity.SERVER_ROOT_LINK_URL+"/emovs_rest/api/write_episode_comment.php";
    @Override
