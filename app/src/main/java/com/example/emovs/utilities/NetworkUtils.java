package com.example.emovs.utilities;
...
import com.example.emovs.Episode;
import com.example.emovs.GeneralShow;
import com.example.emovs.GeneralShowSpec;
import com.example.emovs.MainActivity;
import com.example.emovs.Server;
import com.example.emovs.Session;
...
public class NetworkUtils {
    ...
    private static synchronized String getHttpStringResponse(HttpURLConnection http) throws IOException {
        String ret="";
    ...
    private static synchronized JSONArray useHttpGETRequest(String link){
        String ret = "";
...
//            outputStream.close();
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ret = getHttpStringResponse(http);
    ...
    private static synchronized JSONArray useHttpPOSTRequest(String link , String post_string){
        String ret = "";
        JSONArray ret_array = null;
        try {
            URL url = new URL(link);
    ...
    private static synchronized ArrayList<GeneralShow>  getMainScreenShowsObjectsFromJasonArray(JSONArray arr ) throws JSONException {
        ...
        for( int i = 0 ; i < arr.length() ; i ++ ){
            ...
            int cat_id = Integer.parseInt( String.valueOf(obj.get("cat_id")));
            ...
            int yearOfProduction = Integer.parseInt(String.valueOf(obj.get("year_of_production")));
 ...
 */
    ...
    public static Object LoadeLatestShow(String link ) throws JSONException {
        ArrayList<GeneralShow> loadedMovies;
        JSONArray result = useHttpGETRequest(link);
        if(! is_null(result)) {
 ...
 */
    ...
    public static Object LoadMainScreenShows(String link , String cat) throws  JSONException {
        ArrayList<GeneralShow> loadedShows ;
        JSONArray result = useHttpGETRequest(link );
        if(!is_null(result)) {
    ...
    public static Object LoadMovieLinks(String link, String movieId) throws JSONException {
    ...
    public static Object LoadeEpisodeLinks(String link, String seriesId,String sessionId , String episodeId) throws  JSONException {
        ArrayList<Server> loadesShowServers ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadesShowServers = getShowLinksFromJasonArray(result);
    ...
    public static Object LoadeTags(String link, String movieId) throws JSONException {
    ...
    public static Object LoadeActors(String link, String movieId) throws  JSONException {
    ...
    public static Object LoadeSessions(String link, String seriesId) throws  JSONException {
    ...
    public static Object LoadeEpisodes(String link, String seriesId, String sessionId) throws JSONException {
    ...
    public static Object LoadeNonSeriesLink(String link, String non_series_show_id,String server_id, String cat) throws  JSONException {
        String  loadedLink ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
    ...
    public static Object LoadeActors(String link) throws JSONException {
        ArrayList<Actor> loadedActors ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadedActors = getActorsFromJasonArray(result);
    ...
    public static Object LoadeActorWorks(String link, String actorId) throws  JSONException {
    ...
    public static Object LoadSearchResults(String link, String name) throws JSONException {
        ArrayList<GeneralShow> loadedShows = null ;
        Log.d("DEBUGTAGS" , link.toString());
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadedShows = getMainScreenShowsObjectsFromJasonArray(result );
            return loadedShows;
    ...
    public static Object LoadOurWorks(String link) throws JSONException {
        ArrayList<GeneralShow> loadedShows = null ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadedShows = getMainScreenShowsObjectsFromJasonArray(result );
    ...
    public static Object LoadeUserList(String link , String userid) throws  JSONException {
        ArrayList<GeneralShow> loadedShows = null ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadedShows = getMainScreenShowsObjectsFromJasonArray(result );
    ...
    public static void InsertUser(String link , String email , String userName , String user_photo_url) throws UnsupportedEncodingException, JSONException {
        ...
        JSONArray result = useHttpPOSTRequest(link,post_string);
        if(!is_null(result)){
    ...
    public static Object CheckGeneralShowInListOrNot(String link, String showId, String userid) throws  JSONException {
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            JSONObject obj = (JSONObject) result.get(0);
    ...
    public static Object getKeyValueLinks(String link) throws  JSONException {
    ...
    public static Object getApplicationVersion(String link) throws  JSONException {
    ...
    public static Object LoadReviews(String link, String general_show_id) throws  JSONException {
    ...
    public static Object LoadEpisodeComments(String link, String show_id, String session_id, String episode_id) throws  JSONException {
        ArrayList<Comment> loadedComments = null ;
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            loadedComments = getCommentsFromJasonArray(result );
    ...
    public static Object GetUserRating(String link, String user_id, String show_id) throws  JSONException {
        JSONArray result = useHttpGETRequest(link);
        if(!is_null(result)) {
            JSONObject obj = (JSONObject) result.get(0);
            return String.valueOf(obj.get("id"));
